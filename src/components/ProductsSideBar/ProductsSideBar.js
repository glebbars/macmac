...
const ProductsSideBar = () => {
  ...
  return(
    ...
    { categoryRouteName === 'all-products'  ? 
      <CustomDropDown links initiallyActive options={categoryProductsOptions} brand='Apple' headerClass='products__sidebar__category-header' listClass='drop-down__list_products'/> :
      <>
       <CustomDropDown links initiallyActive options={categoryProductsOptions} brand='Apple' headerClass='products__sidebar__category-header' listClass='drop-down__list_products'/> 
      </> 
