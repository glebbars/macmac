    ...
    <div className="footer">
      <div className="container footer__container">
        <div className="footer__social">
          ...
          <p className="footer__social__text">
        ...
        <div className="footer__info">
          ...
          <div className="footer__info__table">
            ...
            <Link to="/admin" className="footer__link footer__link_admin">
              Become an admin
            </Link>
          </div>
        </div>
        ...
        <div className="footer__contact">
          <h6 className="footer__header footer__header_contact">
            Связаться с нами
          </h6>
          <div className="footer__contact__table">
            <a
              href="tel:+380979549803"
              className="footer__text footer__text_center"
            >
              +38(097)954-98-03
            </a>
            <a
              href="tel:+380634936619"
              className="footer__text footer__text_center"
            >
              +38(063)493-66-19
            </a>
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=notebuts@gmail.com"
              target="_blank"
              rel="noreferrer"
              className="footer__text footer__text_center"
            >
              macmac.brand@gmail.com
            </a>
            <div className="footer__contact__schedule">
              <span className="footer__text footer__contact__schedule__text footer__text_center">
                Пн.-Пт.: 9:00-19:00
              </span>
              <span className="footer__text footer__contact__schedule__text footer__text_center">
                Сб.-Вс.: Выходной
