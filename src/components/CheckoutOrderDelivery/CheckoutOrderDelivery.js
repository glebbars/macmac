...
const CheckoutOrderDelivery = ({register, errors, setValue}) => {
  ...
  return(
    <div className="checkout__order__delivery">
      ...
      <CheckoutOrderDeliveryNovaPoshta register={register} delivery={delivery} setDelivery={setDelivery} errors={errors} setValue={setValue} />
    </div>
  )
}
